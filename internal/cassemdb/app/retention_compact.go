...
type retentionCompactCoordinator interface {
	...
	iterate(param *rangeParam) (*apicassemdb.RangeResp, error)
...
func compactElementHistory(coord retentionCompactCoordinator, req *apicassemdb.CompactElementHistoryReq, now time.Time) (*apicassemdb.CompactElementHistoryResp, error) {
	if coord == nil {
	...
	resp := &apicassemdb.CompactElementHistoryResp{
