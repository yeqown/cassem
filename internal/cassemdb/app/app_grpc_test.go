...
func (f *grpcGetKVsFakeCoord) getKV(key string) (*apicassemdb.Entity, error) {
...
func (f *grpcGetKVsFakeCoord) iterate(*rangeParam) (*apicassemdb.RangeResp, error) {
	return nil, errors.New("unused")
}
func (f *grpcGetKVsFakeCoord) compactElementHistory(*apicassemdb.CompactElementHistoryReq) (*apicassemdb.CompactElementHistoryResp, error) {
	return nil, errors.New("unused")
}
...
func (f *grpcGetKVsFakeCoord) listMembers() ([]*apicassemdb.ClusterMember, error) {
	return nil, errors.New("unused")
}
...
func TestGrpcServerGetKVsReturnsPerKeyErrors(t *testing.T) {
	...
	resp, err := (grpcServer{coord: coord}).GetKVs(context.Background(), &apicassemdb.GetKVsReq{Keys: []string{"cassem/key1", "cassem/key2", "cassem/key3"}})
