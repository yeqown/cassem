...
// Validate checks the field values on KeyError with the rules defined in the
// proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
...
// ValidateAll checks the field values on KeyError with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in KeyErrorMultiError, or nil
// if none found.
func (m *KeyError) ValidateAll() error {
	return m.validate(true)
}

func (m *KeyError) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return KeyErrorMultiError(errors)
	}

	return nil
}

// KeyErrorMultiError is an error wrapping multiple validation errors returned
// by KeyError.ValidateAll() if the designated constraints aren't met.
...
// AllErrors returns a list of validation violation errors.
func (m KeyErrorMultiError) AllErrors() []error { return m }

// KeyErrorValidationError is the validation error returned by
// KeyError.Validate if the designated constraints aren't met.
...
// Field function returns field value.
func (e KeyErrorValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e KeyErrorValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e KeyErrorValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e KeyErrorValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e KeyErrorValidationError) ErrorName() string { return "KeyErrorValidationError" }
...
var _ error = KeyErrorValidationError{}
