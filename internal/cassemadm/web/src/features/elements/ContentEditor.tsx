...
export function ContentEditor({ value, contentType, ariaLabel = 'Raw content', codeTheme = 'github-light-plus', disabled = false, lineWrapping = true, minRows = 12, onChange }: ContentEditorProps) {
